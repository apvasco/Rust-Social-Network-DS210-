...
// Final Project
// Part 1: 
// Does the 6 degrees of separtion actually hold true?
// In this Facebook profile dataset what is true?
...
// USE CARGO RUN--RELEASE FOR QUICKER COMPUTATION 
fn main() {
    println!();
    let graph = Graph::new("facebook_combined.txt");
...
//ran the Facebook dataset between 10-20 times got the degrees of separation between 5.1-5.5
